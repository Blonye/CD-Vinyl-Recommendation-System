...
├── item_vectors.npy       # pre-computed item embeddings (89,370 × 64, L2-norm), which will be regenerated by app.py if missing
├── item_asins.npy         # ASINs in same order as item_vectors rows
...
│   ├── model_bpr.py
│   └── preprocess.py
├── training experiments/  # codings used to train models
│   ├── main.py                      
│   ├── main_test.py                 
│   ├── train_hard.py                
│   ├── eval_full.py                 
│   ├── eval_full_hard.py            
│   ├── eval_full_hr100.py           
│   ├── export_item_vectors.py       
│   ├── build_cache.py               
│   ├── recommend.py                 
│   ├── full_training.log            
│   └── preset_requirements.txt      
